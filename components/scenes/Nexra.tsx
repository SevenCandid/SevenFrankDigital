...
const NexraVisual = dynamic(() => import("@/components/ui/NexraVisual").then((mod) => mod.NexraVisual), { ssr: false });

export function Nexra() {
      ...
      >
        <div ref={ideaRef} className="max-w-2xl text-center flex flex-col gap-6">
          ...
          <h2 className="font-display text-4xl md:text-6xl uppercase tracking-tight leading-[1.1]">
            Businesses need a practical way to reach large audiences quickly and efficiently.
          </h2>
        </div>
      </div>
      ...
      >
        ...
        <div className="flex flex-col gap-6 border-b border-white/[0.08] pb-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
            <div className="flex flex-col gap-2">
              <span className="font-sans text-[10px] uppercase tracking-[0.3em] text-soft-white/40">
                THE SYSTEM
              </span>
            ...
            <div className="flex flex-col gap-2 text-left md:text-right font-sans text-[9px] uppercase tracking-widest">
              <span className="text-soft-white/40">STARTED: FEB 2025</span>
              <span className="text-soft-white/40">DEPLOYED: MID 2026</span>
          ...
          <p className="font-sans text-xs md:text-sm text-soft-white/50 max-w-sm">
            Bulk SMS communication platform.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 pt-2">
          <div className="flex flex-wrap gap-2 font-sans text-[8px] uppercase tracking-widest">
            {["PYTHON", "FASTAPI", "POSTGRESQL", "JAVASCRIPT", "RENDER", "NETLIFY"].map(
              (t) => (
                <span
                  key={t}
                  className="border border-white/[0.12] text-soft-white/40 px-2.5 py-1 rounded-sm"
                >
                  {t}
                </span>
              )
          ...
          <a
            href="https://nexrasms.netlify.app/"
            target="_blank"
            rel="noreferrer"
            className="font-sans text-[10px] uppercase tracking-widest border-b border-soft-white/20 text-soft-white/60 pb-0.5 hover:text-soft-white hover:border-soft-white/60 transition-colors whitespace-nowrap"
            data-cursor="OPEN ↗"
          >
            OPEN NEXRA ↗
          </a>
